...
<c:set var="title"><spring:message code="page.title.calorie.diary.create" /></c:set>
...
<section>
    <div class="row justify-content-center mb-5 border border-2 text-wrapper">
        <div class="col container-fix-width">
            <h1 class="fs-2 mb-0 py-3 ps-3"><spring:message code="text.calorie.diary.create" /></h1>
        </div>
    </div>
    <div class="row justify-content-center">
        <div class="col container-fix-width">
            <form:form modelAttribute="calorieDiaryDTO" action="/calorie-diary/create" method="post"
